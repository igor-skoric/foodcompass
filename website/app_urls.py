...
urlpatterns = [
    ...
    path('aktuelnosti/<int:pk>/brisanje/', app_views.app_news_delete, name='app_news_delete'),
    ...
    path('klijenti/<int:pk>/brisanje/', app_views.app_partner_delete, name='app_partner_delete'),
    ...
    path('saradnja/<int:pk>/brisanje/', _auth_redirect('app_partner_delete')),
    ...
    path('saradnici/<int:pk>/brisanje/', _auth_redirect('app_partner_delete')),
]
